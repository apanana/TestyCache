...
tests/create_akosik: source/test.c source/cachewrapper.c
	$(CC) source/test.c source/cachewrapper.c $(AKOSIK)cache.c $(AKOSIK)lru.c $(CFLAGS) -o tests/create_akosik
...
tests/create_aledger: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(ALEDGER)cache.c $(ALEDGER)dbLL.c $(ALEDGER)evict.c $(ALEDGER)node.c $(CFLAGS) -o tests/create_aledger
...
tests/create_apan: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(APAN)cache.c $(APAN)lru.c $(CFLAGS) -o tests/create_apan
...
tests/create_bblack: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(BBLACK)hash_cache.c $(BBLACK)helper.c $(BBLACK)lru_replacement.c $(CFLAGS) -o tests/create_bblack
...
tests/create_jcosel: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(JCOSEL)cache.c $(CFLAGS) -o tests/create_jcosel
...
tests/create_jhepworth: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(JHEPWORTH)cache.c $(JHEPWORTH)list.c $(JHEPWORTH)slabs.c $(JHEPWORTH)tools.c $(CFLAGS) -o tests/create_jhepworth
...
tests/create_zzhong: source/test.c
	$(CC) source/test.c source/cachewrapper.c $(ZZHONG)cache.c $(ZZHONG)hash_table.c $(ZZHONG)LRU.c $(CFLAGS) -o tests/create_zzhong
