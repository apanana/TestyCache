...
HW3_442: HW3_442.o mytest.o HW3_442_wrapper.o
	$(CC) -o exe1 cache.o test.o HW3_442_wrapper.o
...
HIO: HIO.o mytest.o HIO_wrapper.o
	$(CC) -o exe4 cache.o lru.o test.o HIO_wrapper.o
...
HW3_S: HW3_S.o mytest.o HW3_S_wrapper.o
	$(CC) -o exe3 cache.o list.o slabs.o tools.o test.o HW3_S_wrapper.o
...
HIO2: HIO2.o mytest.o HIO2_wrapper.o
	$(CC) -o exe2 cache.o dbLL.o evict.o node.o test.o HIO2_wrapper.o
